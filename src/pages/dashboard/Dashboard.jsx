...
const Dashboard = ({ onLogout, onViewProject, onViewProjectsList, onCreateProject, onCreateTicket, onViewAllTickets }) => {
  ...
  const fetchUser = async () => {
    ...
    if (user) {
      setUser(user)
      // Get name from user_metadata (set during registration)
  ...
  const stats = [
    { label: 'Total Tickets', value: 0, change: '0%', up: true, icon: '📋' },
    { label: 'Open Tickets', value: 0, change: '0%', up: true, icon: '⏱️' },
    { label: 'Completed', value: 0, change: '0%', up: true, icon: '✅' },
    { label: 'In Progress', value: 0, change: '0%', up: false, icon: '👥' },
  ]
  ...
  <main className="p-6">
          ...
          <div className="flex items-start justify-between mb-8">
            ...
            <button onClick={onCreateProject} className="flex items-center gap-2 px-5 py-2.5 bg-purple-600 text-white rounded-xl font-medium hover:bg-purple-700 transition shadow-lg shadow-purple-200">
  ...
  Create Project
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={onViewProjectsList} className="text-sm font-medium text-purple-600 hover:underline cursor-pointer bg-transparent border-none">View All Projects</button>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <a 
  href="#" 
  onClick={(e) => { e.preventDefault(); onViewAllTickets && onViewAllTickets() }}
